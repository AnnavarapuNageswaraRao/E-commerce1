        ...
        return (
            <>
                <div className="buttons d-flex justify-content-center mb-5 pb-5">
                    ...
                    <button className="btn btn-outline-dark me-2"
                    onClick={()=>filterProduct("men's clothing")}>women's Clothing</button>
                    <button className="btn btn-outline-dark me-2"
                   ...
                   
                {
                    filter.map((product) => {
                        return (
                            <>
                                <div className="row-mid-3 mb-4">
                                    <div className="card  h-100 text-center p-4" key={product.id}>
                                        <img src={product.image} className="card-img-top" alt={product.title}  height='300px'  width='150px'/>
